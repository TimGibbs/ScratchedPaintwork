...
const GeneralRules = () => {
    return <div id="general_rules" className="anchor">
        ...
        <Divider my="md"/>
        <Title order={3} pb="md" pt="md">Attacker Wins on Ties </Title>
        ...
        <Title order={3} pt="md">Critical Defensive success </Title>
        <Text>Similarly, during opposed rolls, the defender always has a chance. On a natural roll of a 10, a defender will
            ...
            evade.</Text>
        <Title order={3} pb="md" pt="md">Advantage and Disadvantage </Title>
        <Text>Some abilities and affects grant Advantage or Disadvantage.</Text>
        <br/>
        <List>
            <List.Item>
        ...
        <Title order={3} pb="md" pt="md">Measuring</Title>
        <Text>In general, players can freely measure distances in advance of choosing actions and targets. </Text>
        <Title order={3} pb="md" pt="md">Terminology</Title>
        <Text>When referring to in game abilities and rules, DECKs and Jockeys are considered a single in game unit. As
            such,
