    ...
    return <div id="core_stats" className="anchor">
        ...
        <Grid gutter={{base: 5, xs: "md", md: "xl", xl: 50}}>
            <Grid.Col span={{base: 12, md: 6}}>
                <Title pb="xs" order={3}>Jockeys</Title>
                <Text pb="xs"> Each Jockey has four stats, defining how effective
                ...
                <Title pb="xs" pt="md" order={3}>DECKS</Title>
                <Text pb="xs"> Dynamic Exoskeletal Combat Kits, or DECKs, are
            ...
            <Grid.Col span={{base: 12, md: 6}}>
                <Title pb="xs" order={3}>Value</Title>
                <Text > Each DECK, Jockey and additional piece of Gear has
                    ...
                    recorded. </Text>
                <Title pb="xs" pt="md" order={3}>Weapon Systems</Title>
                <Text pb="xs"> Each DECK will have at least one Weapon System.
                ...
                <Title pb="xs" pt="md" order={3}>Jam Abilities </Title>
                <Text> Most DECKs have at least one <Text component="span" fw={500}>Jam Ability</Text> installed.
                    ...
                    types: <Text component="span" td="underline">Solo</Text> and <Text component="span"
                                                                                       td="underline">Duel</Text>.</Text>
            </Grid.Col>
        </Grid>
    </div>;
}
